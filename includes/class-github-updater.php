 ...
 *
 * @package GF_Missing_Extensions_Notice
 */
...
/**
 * Class GF_Missing_Extensions_Notice_GitHub_Updater
 *
...
class GF_Missing_Extensions_Notice_GitHub_Updater {
	 ...
	 * @var string
	 */
	private const GITHUB_REPO = 'gf-missing-extensions-notice';
	 ...
	 * @var string
	 */
	private const PLUGIN_FILE = 'gf-missing-extensions-notice/gf-missing-extensions-notice.php';
	 ...
	 * @var string
	 */
	private const PLUGIN_SLUG = 'gf-missing-extensions-notice';
	 ...
	 * @var string
	 */
	private const PLUGIN_NAME = 'Gravity Forms - Missing Extension Notice';
	 ...
	 * @var string
	 */
	private const PLUGIN_DESCRIPTION = 'Warns the admin when a Gravity Forms form requires a missing extension (GF add-on, Gravity Perks, or other). Combines a scan of the form JSON and a scan of the feeds.';
	 ...
	 * @var string
	 */
	private const TEXT_DOMAIN = 'gf-miss-ext';
	 ...
	 * @var string
	 */
	private const CACHE_KEY = 'gf_missing_extensions_notice_release';
...
// Initialize the updater
GF_Missing_Extensions_Notice_GitHub_Updater::init();
